 ...
 * @author Admin
 */
public class JDialog_ThemChiSoDien extends javax.swing.JDialog {

    /**
     * Creates new form JDialog_SuaChiSoDien
     */
    private final ChiSoDienDAOImpl chiSoDienDAOImpl = new ChiSoDienDAOImpl();
    private final ThangDAOImpl thangDAOImpl = new ThangDAOImpl();
    
    private final KhachHang khachHang;
    private Thang thang;
    
    public JDialog_ThemChiSoDien(KhachHang khachHang) {
    ...
    private void initView(){
        ...
        ChiSoDien chiSoDienLast = chiSoDienDAOImpl.getLastChiSoDien(khachHang.getMaKH());
        
        if (chiSoDienLast != null)
            jTextField_ChiSoCu.setText(chiSoDienLast.getChiSoMoi() + "");
    ...
    private void addChiSoDien(){
        ChiSoDien chiSoDienInsert = new ChiSoDien(0, khachHang.getMaKH(), thang.getThangID(),
                Integer.parseInt(jTextField_ChiSoCu.getText()),
                Integer.parseInt(jTextField_ChiSoMoi.getText()),
                new Date());

        if (chiSoDienDAOImpl.createORUpdate(chiSoDienInsert) != 0){
    ...
    private boolean validChiSo(String chiSoCu_text, String chiSoMoi_text){
        try{
            ...
            if (thang != null){
                ChiSoDien chiSoDienSau = chiSoDienDAOImpl.getChiSoDien(khachHang.getMaKH(), thang.getThangID());
