...
(20010811,	'Trần Linh Nhi',	'QuanLy',	'admin',	MD5('admin')	),
(20010813,	'Phạm Văn Phúc',	'QuanLy',	'quanly',	MD5('quanly')	),
(20010824,	'Trinh Đắc Thái',		'ThoDien',	'thodien1',	MD5('123456')	),
(20010800,	'Hoàng Công Chất',	'ThoDien',	'thodien2',	MD5('123456')	),
(20010974,	'Nguyễn Văn Quang',		'ThoDien',	'thodien3',	MD5('1234567')	),
(20010814,	'Trịnh Đình Phúc',	'ThuTien',	'thutien1',	MD5('12345')	),
(20010810,	'Hoàng Thị Kim',	'ThuTien',	'thutien2',	MD5('123456789'));
...
(1000,1,5680,5800,'2023-02-21'),
(1001,1,4500,4750,'2023-02-21'),
(1002,1,1520,1950,'2023-02-21'),
(1003,1,3400,3600,'2023-02-21'),
(1004,1,1000,1200,'2023-02-21'),
(1005,1,1200,1250,'2023-02-21'),
(1006,1,7600,7900,'2023-02-21'),

(1000,2,5800,5990,'2023-03-21'),
(1001,2,4750,4960,'2023-03-21'),
(1002,2,1950,2100,'2023-03-21'),
(1003,2,3600,3900,'2023-03-21'),
(1004,2,1200,1500,'2023-03-21'),
(1005,2,1250,1350,'2023-03-21'),
(1006,2,7900,8200,'2023-03-21'),

(1000,3,5990,6200,'2023-04-21'),
(1001,3,4960,5190,'2023-04-21'),
(1002,3,2100,2200,'2023-04-21'),
(1003,3,3900,4500,'2023-04-21'),
(1004,3,1500,1700,'2023-04-21'),
(1005,3,1350,1401,'2023-04-21'),
(1006,3,8200,8600,'2023-04-21');
...
(100001,1000,1,5800-5680,(5800-5680)*2500,'2023-02-25',true,1005),
(100002,1001,1,4750-4500,(4750-4500)*2500,'2023-02-28',true,1005),
(100003,1002,1,1950-1520,(1950-1520)*2500,'2023-02-26',true,1006),
(100004,1003,1,3600-3400,(3600-3400)*2500,'2023-02-25',true,1006),
(100005,1004,1,1200-1000,(1200-1000)*2500,'2023-02-28',true,1006),
(100006,1005,1,1250-1200,(1250-1200)*2500,'2023-02-25',true,1005),
(100007,1006,1,7900-7600,(7900-7600)*2500,'2023-02-28',true,1005),

(100008,1000,2,5990-5800,(5990-5800)*2500,'2023-03-25',true,1006),
(100009,1001,2,4960-4750,(4960-4750)*2500,'2023-03-25',true,1005),
(100010,1002,2,2100-1950,(2100-1950)*2500,'2023-03-26',true,1006),
(100011,1003,2,3900-3600,(3900-3600)*2500,'2023-03-28',true,1006),
(100012,1004,2,1500-1200,(1500-1200)*2500,'2023-03-25',true,1006),
(100013,1005,2,1350-1250,(1350-1250)*2500,'2023-03-25',true,1005),
(100014,1006,2,8200-7900,(8200-7900)*2500,'2023-03-28',true,1005),

(100015,1000,3,6200-5990,(6200-5990)*2500,'2023-04-26',true,1005),
(100016,1001,3,5190-4960,(5190-4960)*2500,'2023-04-30',true,1006),
(100018,1003,3,4500-3900,(4500-3900)*2500,'2023-04-27',true,1006),
(100020,1005,3,1401-1350,(1401-1350)*2500,'2023-02-26',true,1006);
